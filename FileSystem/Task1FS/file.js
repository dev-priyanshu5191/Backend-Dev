...
// EISDIR = FILEEXPECTED, FOLDER NOT EXIST

// fs.readFile("./hhh.txt", 'utf-8', (err, data) => {
//     if(err){
//         if(err.code === 'ENOENT'){
...
const readStream = fs.createReadStream('./sample.txt')  // Source :- ye data rhega 
const writeStream = fs.createWriteStream("./file.txt")  // Destination :- iss file me sample ka data aa jayega or puarana remove ho jayeg
