...
let teachers = [
    { id: 1, name: "Ruby", city: "mathura", subject: "Big Data" },
    { id: 2, name: "techwalker", city: "kanpur", subject: "techwalk" },
    { id: 3, name: "mayank", city: "Patna", subject: "principal" }
];
...
app.delete("/teacher/:id", (req, resp) => {
    ...
    const deleteteacher = teachers.splice(index, 2);   // splice:- add, remove or delete
